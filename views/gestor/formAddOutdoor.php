                ...
                <section class="section register min-vh-100 d-flex flex-column align-items-center justify-content-center py-4">
                    <div class="container">
                        <div class="row justify-content-center">
                            <div>
                                <a href="index.php?op=adm" class="col-12 ">
                                   <button type="button" class="btn-close btn btn-danger p-2" disabled aria-label="Close"></button>
                                </a>
                            </div>
                            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                                <div class="d-flex justify-content-center py-4">
                                    <a href="index.php?op=adm" class="logo d-flex align-items-center w-auto">
                                        <span class="d-none d-lg-block">ADM Cadastrar Gestor</span>
                                    </a>
                                </div>
